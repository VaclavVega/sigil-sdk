...
class ContentCaptureModeTest {
    ...
    void toMetadataValue() {
        ...
        assertThat(ContentCaptureMode.DEFAULT.toMetadataValue()).isEqualTo("");
    }
    ...
    void callContentCaptureResolver_nullResolverReturnsDefault() {
        assertThat(SigilClient.callContentCaptureResolver(null, null))
    ...
    void callContentCaptureResolver_returnsResolverResult() {
        ...
        assertThat(SigilClient.callContentCaptureResolver(resolver, null))
                .isEqualTo(ContentCaptureMode.METADATA_ONLY);
    }

    @Test
    void callContentCaptureResolver_readsMetadata() {
        Function<Map<String, Object>, ContentCaptureMode> resolver = meta -> {
            if (meta != null && "opted-out".equals(meta.get("tenant_id"))) {
                return ContentCaptureMode.METADATA_ONLY;
            }
            return ContentCaptureMode.FULL;
        };
        assertThat(SigilClient.callContentCaptureResolver(resolver, Map.of("tenant_id", "opted-out")))
                .isEqualTo(ContentCaptureMode.METADATA_ONLY);
        assertThat(SigilClient.callContentCaptureResolver(resolver, Map.of("tenant_id", "normal")))
                .isEqualTo(ContentCaptureMode.FULL);
    }
    ...
    void callContentCaptureResolver_nullReturnBecomesDefault() {
        Function<Map<String, Object>, ContentCaptureMode> resolver = meta -> null;
        assertThat(SigilClient.callContentCaptureResolver(resolver, null))
                .isEqualTo(ContentCaptureMode.DEFAULT);
    }

    // --- shouldIncludeToolContent tests ---
    ...
    void resolver_defaultDefersToClient() {
        Function<Map<String, Object>, ContentCaptureMode> resolver = meta -> ContentCaptureMode.DEFAULT;
