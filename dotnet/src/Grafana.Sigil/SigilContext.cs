...
public static class SigilContext
{
    ...
    internal static IDisposable PushContentCaptureMode(ContentCaptureMode mode)
    {
        ...
        var stack = CaptureStack.Value ?? Array.Empty<CaptureStackEntry>();
        if (stack.Length == 0)
        {
    ...
    private sealed class CaptureStackPop : IDisposable
    {
        private readonly long _recorderId;
        private bool _disposed;

        public CaptureStackPop(long recorderId)
        {
        ...
        public void Dispose()
        {
            ...
            _disposed = true;
            PopContentCaptureMode(_recorderId);
        }
    }
